  ...
  <q-page class="support-page relative overflow-hidden">
    ...
    <div class="page-content q-pa-lg">
      ...
      <div class="text-center q-py-xl">
        <div class="section-label q-mb-xs">Help Us Grow</div>
        <div class="text-h3 text-bold q-mb-sm">Support the Mission</div>
        <div class="text-body1 text-grey-7" style="max-width:600px; margin:0 auto">
          Every membership directly funds accessibility programs, senior facility concerts, and community building at festivals.
        </div>
      </div>
      ...
      <div class="row q-col-gutter-lg justify-center q-mb-xl">
        <div v-for="tier in tiers" :key="tier.id" class="col-12 col-sm-6 col-md-4" style="max-width:340px">
          <q-card
            class="tier-card"
      ...
      <div class="perks-summary q-pa-xl rounded-borders q-mb-xl" style="max-width:860px; margin:0 auto">
        ...
        <div class="row q-col-gutter-lg justify-center">
          <div v-for="perk in globalPerks" :key="perk.title" class="col-12 col-sm-6 col-md-3 text-center">
...
const tiers = [
  {
    ...
    monthly: 5,
    annual: 50,
    stripePriceId: { month: 'price_supporter_monthly', year: 'price_supporter_annual' },
    perks: [
      'Monthly newsletter',
  ...
  },
  {
    ...
    monthly: 15,
    annual: 150,
    stripePriceId: { month: 'price_friend_monthly', year: 'price_friend_annual' },
    perks: [
  ...
  },
  {
    ...
    monthly: 25,
    annual: 250,
    stripePriceId: { month: 'price_champion_monthly', year: 'price_champion_annual' },
    perks: [
...
async function checkout(tier: Tier) {
  ...
  const priceId = tier.stripePriceId[interval.value]
